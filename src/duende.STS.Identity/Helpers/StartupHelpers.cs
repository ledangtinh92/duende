...
using duende.STS.Identity.Configuration;
using duende.STS.Identity.Configuration.ApplicationParts;
using duende.STS.Identity.Configuration.Constants;
using duende.STS.Identity.Configuration.Interfaces;
using duende.STS.Identity.Helpers.Localization;
using duende.STS.Identity.Services;
